...
@section('content')
    ...
    <div class="max-w-2xl mx-auto text-center mb-12">
        <img src="https://www.gravatar.com/avatar/{{ md5(strtolower(trim($author->user_email))) }}?s=128&d=mp"
             ...
             class="size-24 rounded-full mx-auto mb-4 ring-4 ring-white shadow">

        <h1 class="text-2xl font-bold mb-1">{{ $author->display_name }}</h1>

        @if ($author->getMeta('description'))
            <p class="text-gray-500 text-sm leading-relaxed mb-4 max-w-lg mx-auto">
        ...
        <div class="flex items-center justify-center gap-6 text-sm text-gray-400">
            <span>
                <strong class="text-gray-700 font-semibold">{{ $posts->total() }}</strong>
