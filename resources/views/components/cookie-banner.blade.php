<div id="cookie-banner"
    ...
    <div class="bg-white border-t-2 border-indigo-500 shadow-[0_-8px_30px_rgba(0,0,0,0.12)]">
        <div class="max-w-8xl mx-auto px-18 py-5 flex flex-col sm:flex-row sm:items-center gap-5">
            <div class="flex items-start gap-4 flex-1 min-w-0">
                <div class="shrink-0 mt-0.5 w-9 h-9 rounded-full bg-indigo-50 flex items-center justify-center text-indigo-600">
                ...
                <div class="min-w-0">
                    <p class="text-sm font-semibold text-gray-900 mb-0.5">We value your privacy</p>
                    <p class="text-sm text-gray-500 leading-relaxed">
                        We use cookies to improve your browsing experience and analyse site traffic.
                        <a href="#" class="text-indigo-600 hover:underline underline-offset-2 transition-colors">Learn more</a>
                    </p>
                </div>
            </div>
            <div class="flex items-center gap-3 shrink-0 sm:pl-4">
                <button id="cookie-decline"
                        class="px-4 py-2 rounded-lg text-sm font-medium text-gray-600 bg-gray-100 hover:bg-gray-200 transition-colors cursor-pointer">
                    Decline
                </button>
                <button id="cookie-accept"
                        class="px-5 py-2 rounded-lg text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 transition-colors shadow-sm cursor-pointer">
                    Accept All
                </button>
            </div>
        </div>
