        ...
        <div>
            @if ($previousPost)
                <a href="{{ route('posts.show', $previousPost->slug) }}"
                   class="group flex flex-col gap-1 text-sm hover:text-indigo-600 transition-colors">
        ...
        <div class="text-right">
            @if ($nextPost)
                <a href="{{ route('posts.show', $nextPost->slug) }}"
                   class="group flex flex-col gap-1 items-end text-sm hover:text-indigo-600 transition-colors">
                    <span class="text-xs text-gray-400 flex items-center gap-1">
                        Next
